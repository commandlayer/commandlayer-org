...
async function trackPinnedCardRegistration(card) {
  const chainId = process.env.ERC8004_CHAIN_ID || DEFAULT_ERC8004_CHAIN_ID;
  const registryAddress = process.env.ERC8004_REGISTRY_ADDRESS || DEFAULT_ERC8004_REGISTRY_ADDRESS;
