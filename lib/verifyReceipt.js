...
function hasGenesisSchema(receipt) {
  return Boolean(
    receipt &&
      ...
      (receipt.subject_agent === undefined || (typeof receipt.subject_agent === 'string' && receipt.subject_agent === receipt.agent)) &&
      (receipt.issuer_role === undefined || receipt.issuer_role === 'platform_genesis_attestor') &&
...
module.exports = { verifyReceipt, computeReceiptHash, resolveSignerFromEns };
